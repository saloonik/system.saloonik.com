        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 h-9 bg-transparent">
                    <TabsTrigger value="personal" className="text-[#393637] data-[state=active]:text-white data-[state=active]:bg-[#393637] dark:data-[state=active]:bg-[#393637]">
                        Osobowe
                    </TabsTrigger>
                    <TabsTrigger value="company" className="text-[#393637] data-[state=active]:text-white data-[state=active]:bg-[#393637] dark:data-[state=active]:bg-[#393637]">
                        Firma
                    </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="personal" className="space-y-3 pt-3">
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="register-password" className="text-sm text-[#393637]">
                            Hasło
                        </Label>
                        <Input
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="confirm-password" className="text-sm text-[#393637]">
                            Potwierdź hasło
                        </Label>
                        <Input
                            id="confirm-password"
                ...
                <TabsContent value="company" className="space-y-3 pt-3">
                    ...
                    <div className="flex items-center space-x-2 pt-1">
                        ...
                        />
                        <label htmlFor="terms" className="text-xs font-medium leading-none text-[#393637]">
                            Akceptuję regulamin
                        </label>
                    </div>
